...
#. Clone git repo for the dcos swarm cli::

    git clone git@github.com:mesosphere/dcos-swarm.git
...
#. :code:`source` the setup file to add the :code:`dcos-swarm` command line interface to your
   :code:`PATH`::

    source env/bin/activate

#. Get started by calling the DCOS Swarm CLI's help::
